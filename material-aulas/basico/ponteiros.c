...
/*
 ...
 - Usamos o operador * ("conteúdo de") para acessar ou modificar o valor guardado nesse endereço.
...
int main() {
    ...
    *p = 99;           // muda o valor de x indiretamente
    ...
    // Um ponteiro pode apontar para OUTRA variável:
    int y = -7;
    p = &y;   // agora p não aponta mais para x, e sim para y
    printf("Agora p aponta para y: *p = %d\n", *p);

    // Ponteiro nulo (NULL): usado quando não há destino válido
